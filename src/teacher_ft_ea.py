...
tokenizer = AutoTokenizer.from_pretrained('./models/teacher_ft_ea_5k_balanced')
...
class ToxicCommentClassifier(pl.LightningModule):
    def __init__(self, n_classes: int, steps_per_epoch=None, n_epochs=None):
        super().__init__()
        self.model = RobertaForSequenceClassification.from_pretrained("./models/teacher_ft_ea_5k_balanced", num_labels=n_classes)
...
checkpoint_dir = "./models/teacher_ft_ea_lightning"
...
val_df = pd.read_csv("../Augmentation/train_ch.csv")
val_dataset = Dataset.from_pandas(val_df)
val_dataset = val_dataset.map(tokenize, batched=True)
val_dataset.set_format(type='torch', columns=['input_ids', 'attention_mask', 'Label'])
val_dataset = val_dataset.shuffle(seed=42)

test_df = pd.read_csv("../Augmentation/test_ch.csv")
...
train_dataset.save_to_disk('./models/teacher_ft_ea_5k_1k_ch_balanced' + '/train_set')
val_dataset.save_to_disk('./models/teacher_ft_ea_5k_1k_ch_balanced' + '/val_set')
test_dataset.save_to_disk('./models/teacher_ft_ea_5k_1k_ch_balanced' + '/test_set')
train_dataset = load_from_disk('./models/teacher_ft_ea_5k_1k_ch_balanced' + '/train_set')
val_dataset = load_from_disk('./models/teacher_ft_ea_5k_1k_ch_balanced' + '/val_set')
test_dataset = load_from_disk('./models/teacher_ft_ea_5k_1k_ch_balanced' + '/test_set')
...
train_loader = DataLoader(train_dataset, batch_size=16, shuffle=True, num_workers=7, collate_fn=data_collator)
val_loader = DataLoader(val_dataset, batch_size=16, num_workers=7, collate_fn=data_collator, shuffle=False)
test_loader = DataLoader(test_dataset, batch_size=16, num_workers=7, collate_fn=data_collator, shuffle=False)
...
model.model.save_pretrained('./models/teacher_ft_ea_5k_1k_ch_balanced')
tokenizer.save_pretrained('./models/teacher_ft_ea_5k_1k_ch_balanced')
